      ...
      <div style="display: flex; flex-direction: column; align-items: flex-end; position: relative; gap: 6px;">
        <div class="chat-preview-bubble"
          ...
          <button class="close-bubble"
            style="position: absolute; top: 2px; right: 4px; background: none; border: none; font-size: 16px; color: #888; cursor: pointer; opacity: 0; transition: opacity 0.2s;">×</button>
        </div>
